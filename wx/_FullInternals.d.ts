...
export declare const Konva: {
    ...
    Util: {
        ...
        _getProjectionToLine(pt: import("./types").Vector2d, line: Array<import("./types").Vector2d>, isClosed: boolean): import("./types").Vector2d;
        ...
        drawRoundedRectPath(context: import("./Context").Context, width: number, height: number, cornerRadius: number | number[]): void;
    };
    ...
    DD: {
        ...
        justDragged: boolean;
        readonly node: import("./Node").Node<import("./Node").NodeConfig> | undefined;
